...
//입력되지 않은 변수는 반드시 테케마다 초기화 해서 사용할 것~!!!!
public class Solution {
	static BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
	static StringBuilder output = new StringBuilder();
	static StringTokenizer tokens;
	static int T = 10;
	static int[] map = new int[100]; //가로의 길이는 항상 100이라고 함
	static int dumpCnt;
	static int minidx = 0;
	static int maxidx = map.length-1;
	...
	public static void main(String[] args) throws IOException {
		...
		for(int t=1; t<=T; t++) {
			...
			dumpCnt = Integer.parseInt(tokens.nextToken());
			...
			output.append("#").append(t).append(" ").append(map[maxidx] - map[minidx]).append("\n");
		}//end testcase
		System.out.print(output);
	}
	
	static String instr = "834\r\n" + 
